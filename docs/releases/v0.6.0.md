...
- Added import flows for OpenClaw, OpenCode, Aider, and NemoClaw so existing provider configuration can be brought into Carapace with previewed mappings.
...
- If you are coming from another tool, prefer an import flow instead of hand-copying secrets:
