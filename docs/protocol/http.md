...
| `dlq-decryption` | Matrix inbound DLQ decrypt/key selection failed. | Check Matrix store key history and interrupted rekey state; follow the store rekey-recovery procedure before replay. |
