...
- **`vertex`**
  ...
  - *Behavior notes:*
    ...
    - Cloud Run services, Cloud Run Jobs, and Cloud Run Worker Pools bypass `gcloud` and query the metadata server directly; `gcloudTokenTimeoutMs` does not apply on that bypass path.
