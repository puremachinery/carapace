...
| Signal | Implemented (smoke pending) | Inbound WebSocket receive stream (JSON-RPC mode), typing indicators, and append-time read receipts are implemented; live smoke evidence pending. |
